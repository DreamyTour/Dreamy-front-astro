  ...
  return (
    <div className="bg-white rounded-sm p-6 md:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-gray-100 flex flex-col relative overflow-hidden">
      ...
      <div className="mb-6 mt-2">
        <span className="text-secondary font-bold tracking-wider uppercase text-xs inline-block mb-1">Reserva tu aventura</span>
      ...
      >
        ...
        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 relative z-10" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">o por correo</span>
        <div className="h-px bg-gray-200 flex-1"></div>
      </div>
